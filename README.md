...
RobotTestSwiftCLI is a command-line executable swift package that contains a library dependency and a test target. Everything is run from the command line however there are some environment requirements:
